...
class AdvertisingAgent(
    ...
    override val agentIdentifier: String = "Agent PublicitaƒÂ©"
    override val authorityLevel: Int = 4
    override val agentDomain: String = "ADVERTISING"

    override suspend fun dispatch(command: Command) {
        log("CraƒÂ©ation de la campagne publicitaire pour : " + command.instruction)
        val thought = performAction("RaƒÂ©dige un message publicitaire percutant pour : " + command.instruction)
